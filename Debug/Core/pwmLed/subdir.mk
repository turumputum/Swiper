...
OBJS += \
./Core/pwmLed/PwmLed.o \
./Core/pwmLed/hsv.o 

C_DEPS += \
./Core/pwmLed/PwmLed.d \
./Core/pwmLed/hsv.d 


# Each subdirectory must supply rules for building sources it contributes
Core/pwmLed/%.o Core/pwmLed/%.su: ../Core/pwmLed/%.c Core/pwmLed/subdir.mk
...
clean: clean-Core-2f-pwmLed

clean-Core-2f-pwmLed:
	-$(RM) ./Core/pwmLed/PwmLed.d ./Core/pwmLed/PwmLed.o ./Core/pwmLed/PwmLed.su ./Core/pwmLed/hsv.d ./Core/pwmLed/hsv.o ./Core/pwmLed/hsv.su

.PHONY: clean-Core-2f-pwmLed
